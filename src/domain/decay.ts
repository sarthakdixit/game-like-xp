...
/**
 * Whole days between two ISO timestamps. Clamped to 0 for a negative gap
...
/**
 * Applies neglect decay to a child stat's current value. Clamped at 0 — a long gap
 * (e.g. reinstalling the app after months away) decays fully rather than going negative.
 */
